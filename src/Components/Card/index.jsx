...
const Card = (data) => {
    ...
    const renderIcon = (id) => {
        ...
        if (isInCart) {
            ...
            return(
                <div className="absolute top-0 right-0 flex justify-center items-center bg-white w-6 h-6 rounded-full m-2" onClick={(event) => addProductsToCart(event, data.data)}>
    ...
    return(
        <div className="bg-white cursor-pointer w-56 h-60 rounded-lg mb-4" onClick={() => showProducts(data.data) }>
